                ...
                <Mutation mutation={deleteCartItem}>
                  ...
                  <CartItem>
                      ...
                      <ItemsDetails>
                        ...
                        <ItemControls>
                        <div onClick={() => onRemoveQuantityClicked(product.id, quantity, variants, addItem)}>
                          ...
                          <div onClick={() => onAddQuantityClicked(product.id, quantity, variants, addItem)}>
              ...
              {({ loading, error, data }) => {
                ...
                return(
                    <>
                      ...
                      <Divider />
                      <Wrapper>
                        {renderCartItems(data.getMeCart[0].items)}
                      </Wrapper>
                    </>
                );
              }}
